        ...
        private void button2_Click_1(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < lstnodefinal.Count; i++)
            {
                ...
                if (lstout.Count >= lstsort[lstsort.Count - (lstsort.Count / 10)])
                {
                    ...
                    lstrids.Add("Path " + arrpath[i].ToString() + " (" + arrtrongso[i].ToString() + ")" + ":");
                    for (int j = 0; j < lstout.Count; j++)
                    {
            ...
            richtxbout.Text += "Total path :" + countpath.ToString();
            lstrids.Add("Total path :" + countpath.ToString());
